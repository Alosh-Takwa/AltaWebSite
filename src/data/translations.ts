export interface TranslationSet {
  ...
  statCampaignsVal: string;
  statExperience: string;
  statExperienceVal: string;
  statBillboards: string;
  statBillboardsVal: string;

  genTitle: string;
  genSub: string;
  genLabelName: string;
  genPlaceholderName: string;
  genLabelType: string;
  genPlaceholderType: string;
  genLabelLocation: string;
  genLabelTone: string;
  genLabelAudience: string;
  genBtnSubmit: string;
  genBtnGenerating: string;
  genResultSlogan: string;
  genResultConcept: string;
  genResultVideo: string;
  genResultBillboard: string;
  genResultStrategy: string;
  genDemoNotice: string;
  ...
  calcTitle: string;
  calcSub: string;
  calcLabelType: string;
  calcLabelBudget: string;
  calcEstReach: string;
  calcTargetCity: string;
  calcFormSponsor: string;

  portTitle: string;
  portSub: string;
  portTagOutdoor: string;
  portTagDigital: string;
  portTagBrand: string;
  portTagVideo: string;
  portItem1Title: string;
  portItem1Desc: string;
  portItem2Title: string;
  portItem2Desc: string;
  portItem3Title: string;
  portItem3Desc: string;
  portItem4Title: string;
  portItem4Desc: string;
...
export const enTranslations: TranslationSet = {
  ...
  portItem4Desc: "A warm, deeply moving cinematic TV ad highlighting the emotional beauty of Syrian family gatherings, winning regional awards for advertising excellence.",
